module github.com/ntnn/mermaid-kube-live
...
require (
	...
	github.com/ntnn/mcutils v0.0.0-20260328010225-ef611aee013b
	...
	sigs.k8s.io/multicluster-runtime/providers/file v0.23.2-0.20260331120416-fcffbcd3b43b
